...
public class PostsRecord extends UpdatableRecordImpl<PostsRecord> implements Record2<Integer, String> {
    ...
    /**
     * Setter for <code>public.posts.name</code>.
     */
    ...
    /**
     * Getter for <code>public.posts.name</code>.
     */
    ...
    @Override
    public PostsRecord values(Integer value1, String value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public PostsRecord(Integer id, String name) {
        super(Posts.POSTS);
